...
<div class="kb"></div>
<div style="text-align: center"><h1>新增班级公告</h1>
    <form class="well form-horizontal" action="/notice/create/" method="post">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-4">
                <textarea class="form-control" id="notice" name="notice" cols="30" rows="10"
                          placeholder="班级公告"></textarea><br>
            </div>
        </div>
        <div class="form-group">
            <div class="col-sm-4">
