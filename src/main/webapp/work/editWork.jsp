...
<div class="container">
    <div class="jumbotron">
        <h1 class="text-center">修改就业信息</h1>
    </div>
    <form class="well form-horizontal" action="${ctx}/work/editWork" method="post">
        <input type="hidden" name="id" value="${sessionScope.work.id}">
        <input type="hidden" name="studentId" value="${sessionScope.work.studentId}"><br>
        <div class="form-group">
            <label class="control-label col-sm-2" for="workUnit">就业单位:</label>
            <div class="col-sm-4">
                <input class="form-control" type="text" name="workUnit" id="workUnit"
                       value="${sessionScope.work.workUnit}"><br>
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-sm-4">
                <input class="form-control" type="text" name="position" id="position"
                       value="${sessionScope.work.position}"><br>
            </div>
        </div>
        <div class="form-group">
            <div class="col-sm-offset-2 col-sm-4">
                <button type="submit" class="btn btn-group-lg btn-success">提交</button>
            </div>
        </div>
    </form>
</div>
